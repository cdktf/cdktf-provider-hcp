// https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action
...
export interface WaypointActionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#description WaypointAction#description}
  */
  readonly description?: string;
  /**
  * The name of the Action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#name WaypointAction#name}
  */
  readonly name: string;
  /**
  * The ID of the HCP project where the Action is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#project_id WaypointAction#project_id}
  */
  readonly projectId?: string;
  /**
  * The kind of HTTP request this should trigger.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#request WaypointAction#request}
  */
...
export interface WaypointActionRequestCustom {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#body WaypointAction#body}
  */
  readonly body?: string;
  /**
  * Key value headers to send with the request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#headers WaypointAction#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * The HTTP method to use for the request. Must be one of: 'GET', 'POST', 'PUT', 'DELETE', or 'PATCH'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#method WaypointAction#method}
  */
  readonly method: string;
  /**
  * The full URL this request should make when invoked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#url WaypointAction#url}
  */
  readonly url?: string;
}
...
export interface WaypointActionRequest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#custom WaypointAction#custom}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action hcp_waypoint_action}
*/
export class WaypointAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_action hcp_waypoint_action} Resource
  *
  * @param scope The scope in which to define this construct
