// https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/data-sources/aws_network_peering
...
export class DataHcpAwsNetworkPeering extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpAwsNetworkPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/data-sources/aws_network_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/data-sources/aws_network_peering hcp_aws_network_peering} Data Source
  *
  * @param scope The scope in which to define this construct
