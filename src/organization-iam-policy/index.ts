// https://registry.terraform.io/providers/hashicorp/hcp/0.86.0/docs/resources/organization_iam_policy
...
export class OrganizationIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.86.0/docs/resources/organization_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.86.0/docs/resources/organization_iam_policy hcp_organization_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
