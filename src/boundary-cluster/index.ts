// https://registry.terraform.io/providers/hashicorp/hcp/0.106.0/docs/resources/boundary_cluster
...
export interface BoundaryClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly authTokenTimeToLive?: string;
  /**
  ...
  */
  readonly authTokenTimeToStale?: string;
  /**
...
export class BoundaryCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BoundaryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.106.0/docs/resources/boundary_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.106.0/docs/resources/boundary_cluster hcp_boundary_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: BoundaryClusterConfig) {
    ...
    this._authTokenTimeToLive = config.authTokenTimeToLive;
    this._authTokenTimeToStale = config.authTokenTimeToStale;
  ...
  // auth_token_time_to_live - computed: false, optional: true, required: false
  private _authTokenTimeToLive?: string; 
  public get authTokenTimeToLive() {
    return this.getStringAttribute('auth_token_time_to_live');
  }
  public set authTokenTimeToLive(value: string) {
    this._authTokenTimeToLive = value;
  }
  public resetAuthTokenTimeToLive() {
    this._authTokenTimeToLive = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get authTokenTimeToLiveInput() {
    return this._authTokenTimeToLive;
  }

  // auth_token_time_to_stale - computed: false, optional: true, required: false
  private _authTokenTimeToStale?: string; 
  public get authTokenTimeToStale() {
    return this.getStringAttribute('auth_token_time_to_stale');
  }
  public set authTokenTimeToStale(value: string) {
    this._authTokenTimeToStale = value;
  }
  public resetAuthTokenTimeToStale() {
    this._authTokenTimeToStale = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get authTokenTimeToStaleInput() {
    return this._authTokenTimeToStale;
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      maintenance_window_config: {
        value: boundaryClusterMaintenanceWindowConfigToHclTerraform(this._maintenanceWindowConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BoundaryClusterMaintenanceWindowConfigList",
      },
      timeouts: {
        value: boundaryClusterTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "BoundaryClusterTimeouts",
      },
    };
