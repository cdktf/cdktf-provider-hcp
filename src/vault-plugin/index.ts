...
// https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/vault_plugin
...
export class VaultPlugin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/vault_plugin#import import section} in the documentation of this resource for the id to use
