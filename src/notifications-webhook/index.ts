...
// https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook
...
export interface NotificationsWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#config NotificationsWebhook#config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#description NotificationsWebhook#description}
  */
  readonly description?: string;
  /**
  * Indicates if the webhook should receive payloads for the subscribed events. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#enabled NotificationsWebhook#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The webhook's name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#name NotificationsWebhook#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#project_id NotificationsWebhook#project_id}
  */
  readonly projectId?: string;
  /**
  * Set of events to subscribe the webhook to all resources or a specific resource in the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#subscriptions NotificationsWebhook#subscriptions}
  */
...
export interface NotificationsWebhookConfigA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#hmac_key NotificationsWebhook#hmac_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#url NotificationsWebhook#url}
  */
  readonly url: string;
}
...
export interface NotificationsWebhookSubscriptionsEvents {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#actions NotificationsWebhook#actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#source NotificationsWebhook#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook hcp_notifications_webhook}
*/
export class NotificationsWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationsWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/notifications_webhook hcp_notifications_webhook} Resource
  *
  * @param scope The scope in which to define this construct
