// https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs/resources/notifications_webhook
...
export class NotificationsWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationsWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs/resources/notifications_webhook#import import section} in the documentation of this resource for the id to use
