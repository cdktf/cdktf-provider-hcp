// https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application
...
export interface WaypointApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#application_input_variables WaypointApplication#application_input_variables}
  */
  readonly applicationInputVariables?: WaypointApplicationApplicationInputVariables[] | cdktf.IResolvable;
  /**
  * The name of the Application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#name WaypointApplication#name}
  */
  readonly name: string;
  /**
  * The ID of the HCP project where the Waypoint Application is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#project_id WaypointApplication#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#readme_markdown WaypointApplication#readme_markdown}
  */
  readonly readmeMarkdown?: string;
  /**
  * ID of the Template this Application is based on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#template_id WaypointApplication#template_id}
  */
...
export interface WaypointApplicationApplicationInputVariables {
  ...
  * Variable value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#value WaypointApplication#value}
  */
  readonly value: string;
  /**
  * Variable type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#variable_type WaypointApplication#variable_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application hcp_waypoint_application}
*/
export class WaypointApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/resources/waypoint_application hcp_waypoint_application} Resource
  *
  * @param scope The scope in which to define this construct
