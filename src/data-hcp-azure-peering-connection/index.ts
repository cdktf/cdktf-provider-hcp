...
// https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/azure_peering_connection
...
export class DataHcpAzurePeeringConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpAzurePeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/azure_peering_connection#import import section} in the documentation of this resource for the id to use
