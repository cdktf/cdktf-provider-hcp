// https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs
...
export class HcpProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HcpProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs#import import section} in the documentation of this resource for the id to use
