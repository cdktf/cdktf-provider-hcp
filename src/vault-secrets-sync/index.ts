...
// https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync hcp_vault_secrets_sync}
*/
export class VaultSecretsSync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/vault_secrets_sync hcp_vault_secrets_sync} Resource
  *
  * @param scope The scope in which to define this construct
