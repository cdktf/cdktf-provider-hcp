...
// https://registry.terraform.io/providers/hashicorp/hcp/0.107.0/docs/data-sources/group
...
export class DataHcpGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.107.0/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.107.0/docs/data-sources/group hcp_group} Data Source
  *
  * @param scope The scope in which to define this construct
