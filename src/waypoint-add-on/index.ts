// https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/resources/waypoint_add_on
...
export class WaypointAddOn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointAddOn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/resources/waypoint_add_on#import import section} in the documentation of this resource for the id to use
