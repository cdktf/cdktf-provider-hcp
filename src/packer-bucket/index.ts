// https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/packer_bucket
...
export class PackerBucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PackerBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/packer_bucket#import import section} in the documentation of this resource for the id to use
