// https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/vault_secrets_app_iam_policy
...
export class VaultSecretsAppIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsAppIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/vault_secrets_app_iam_policy#import import section} in the documentation of this resource for the id to use
