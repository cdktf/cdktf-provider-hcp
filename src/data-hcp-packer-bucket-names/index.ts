// https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/packer_bucket_names
...
export class DataHcpPackerBucketNames extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpPackerBucketNames that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/packer_bucket_names#import import section} in the documentation of this resource for the id to use
