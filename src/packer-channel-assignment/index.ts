...
// https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/packer_channel_assignment
...
export class PackerChannelAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PackerChannelAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/packer_channel_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/resources/packer_channel_assignment hcp_packer_channel_assignment} Resource
  *
  * @param scope The scope in which to define this construct
