...
// https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/packer_artifact
...
export class DataHcpPackerArtifact extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpPackerArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/data-sources/packer_artifact#import import section} in the documentation of this resource for the id to use
