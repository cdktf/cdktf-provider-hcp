...
// https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/vault_secrets_integration_aws
...
export interface VaultSecretsIntegrationAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly accessKeys?: VaultSecretsIntegrationAwsAccessKeys;
  /**
  ...
  */
  readonly federatedWorkloadIdentity?: VaultSecretsIntegrationAwsFederatedWorkloadIdentity;
  /**
...
export class VaultSecretsIntegrationAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsIntegrationAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/vault_secrets_integration_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/vault_secrets_integration_aws hcp_vault_secrets_integration_aws} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _accessKeys = new VaultSecretsIntegrationAwsAccessKeysOutputReference(this, "access_keys");
  public get accessKeys() {
    return this._accessKeys;
  }
  public putAccessKeys(value: VaultSecretsIntegrationAwsAccessKeys) {
  ...
  private _federatedWorkloadIdentity = new VaultSecretsIntegrationAwsFederatedWorkloadIdentityOutputReference(this, "federated_workload_identity");
  public get federatedWorkloadIdentity() {
    return this._federatedWorkloadIdentity;
  }
  public putFederatedWorkloadIdentity(value: VaultSecretsIntegrationAwsFederatedWorkloadIdentity) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      access_keys: vaultSecretsIntegrationAwsAccessKeysToTerraform(this._accessKeys.internalValue),
      capabilities: cdktf.listMapper(cdktf.stringToTerraform, false)(this._capabilities),
      federated_workload_identity: vaultSecretsIntegrationAwsFederatedWorkloadIdentityToTerraform(this._federatedWorkloadIdentity.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      access_keys: {
        value: vaultSecretsIntegrationAwsAccessKeysToHclTerraform(this._accessKeys.internalValue),
        isBlock: true,
        type: "struct",
      ...
      federated_workload_identity: {
        value: vaultSecretsIntegrationAwsFederatedWorkloadIdentityToHclTerraform(this._federatedWorkloadIdentity.internalValue),
        isBlock: true,
        type: "struct",
