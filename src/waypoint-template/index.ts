// https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_template
...
export interface WaypointTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * If true, will auto-import the readme form the Terraform module used. If this is set to true, users should not also set `readme_markdown_template`.
  *
...
export class WaypointTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaypointTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/resources/waypoint_template hcp_waypoint_template} Resource
  *
  * @param scope The scope in which to define this construct
