...
// https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/hvn_route
...
export class DataHcpHvnRoute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpHvnRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/hvn_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/hvn_route hcp_hvn_route} Data Source
  *
  * @param scope The scope in which to define this construct
