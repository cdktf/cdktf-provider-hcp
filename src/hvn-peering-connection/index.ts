...
// https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/resources/hvn_peering_connection
...
export class HvnPeeringConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HvnPeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/resources/hvn_peering_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.82.0/docs/resources/hvn_peering_connection hcp_hvn_peering_connection} Resource
  *
  * @param scope The scope in which to define this construct
