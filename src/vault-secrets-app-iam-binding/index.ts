...
// https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/vault_secrets_app_iam_binding
...
export class VaultSecretsAppIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsAppIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/vault_secrets_app_iam_binding#import import section} in the documentation of this resource for the id to use
