// https://registry.terraform.io/providers/hashicorp/hcp/0.76.0/docs/data-sources/packer_run_task
...
export class DataHcpPackerRunTask extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpPackerRunTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.76.0/docs/data-sources/packer_run_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.76.0/docs/data-sources/packer_run_task hcp_packer_run_task} Data Source
  *
  * @param scope The scope in which to define this construct
