...
// https://registry.terraform.io/providers/hashicorp/hcp/0.83.0/docs/data-sources/boundary_cluster
...
export class DataHcpBoundaryCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpBoundaryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.83.0/docs/data-sources/boundary_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.83.0/docs/data-sources/boundary_cluster hcp_boundary_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
