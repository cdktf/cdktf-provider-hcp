// https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/consul_versions
...
export class DataHcpConsulVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpConsulVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/consul_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/data-sources/consul_versions hcp_consul_versions} Data Source
  *
  * @param scope The scope in which to define this construct
