// https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy
...
export interface GroupIamPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy#name GroupIamPolicy#name}
  */
  readonly name: string;
  /**
  * The policy to apply.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy#policy_data GroupIamPolicy#policy_data}
  */
  readonly policyData: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy hcp_group_iam_policy}
*/
export class GroupIamPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.96.0/docs/resources/group_iam_policy hcp_group_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
