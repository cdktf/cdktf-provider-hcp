// https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/data-sources/iam_policy
...
export class DataHcpIamPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/data-sources/iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.94.0/docs/data-sources/iam_policy hcp_iam_policy} Data Source
  *
  * @param scope The scope in which to define this construct
