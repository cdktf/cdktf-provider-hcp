...
// https://registry.terraform.io/providers/hashicorp/hcp/0.107.0/docs/data-sources/hvn
...
export class DataHcpHvn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpHvn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.107.0/docs/data-sources/hvn#import import section} in the documentation of this resource for the id to use
