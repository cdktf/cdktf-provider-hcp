// https://registry.terraform.io/providers/hashicorp/hcp/0.98.1/docs/data-sources/hvn
...
export class DataHcpHvn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpHvn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.98.1/docs/data-sources/hvn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.98.1/docs/data-sources/hvn hcp_hvn} Data Source
  *
  * @param scope The scope in which to define this construct
