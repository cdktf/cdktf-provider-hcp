...
// https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/log_streaming_destination
...
export class LogStreamingDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogStreamingDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.97.0/docs/resources/log_streaming_destination#import import section} in the documentation of this resource for the id to use
