// https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/resources/consul_cluster_root_token
...
export class ConsulClusterRootToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConsulClusterRootToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.0/docs/resources/consul_cluster_root_token#import import section} in the documentation of this resource for the id to use
