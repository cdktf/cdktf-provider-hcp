// https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/data-sources/consul_cluster
...
export class DataHcpConsulCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcpConsulCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/data-sources/consul_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.105.0/docs/data-sources/consul_cluster hcp_consul_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
