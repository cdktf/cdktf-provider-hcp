// https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/service_principal
...
export class ServicePrincipal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.91.1/docs/resources/service_principal#import import section} in the documentation of this resource for the id to use
