// https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs/resources/vault_secrets_secret
...
export class VaultSecretsSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultSecretsSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.92.0/docs/resources/vault_secrets_secret#import import section} in the documentation of this resource for the id to use
