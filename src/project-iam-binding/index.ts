// https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding
...
export interface ProjectIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding#principal_id ProjectIamBinding#principal_id}
  */
  readonly principalId: string;
  /**
  * The ID of the HCP project to apply the IAM Policy to. If unspecified, the project configured on the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding#project_id ProjectIamBinding#project_id}
  */
  readonly projectId?: string;
  /**
  * The role name to bind to the given principal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding#role ProjectIamBinding#role}
  */
...
export class ProjectIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/hcp/0.93.0/docs/resources/project_iam_binding hcp_project_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
