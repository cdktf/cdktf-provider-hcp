...
This repo builds and publishes the [Terraform hcp provider](https://registry.terraform.io/providers/hashicorp/hcp/0.111.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
