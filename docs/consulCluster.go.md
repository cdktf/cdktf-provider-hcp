...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/consulcluster"
...
&consulcluster.ConsulClusterConfig {
	...
	Size: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.consulCluster.ConsulClusterTimeouts,
}
```
