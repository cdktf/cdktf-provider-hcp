...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/consulcluster"
...
&consulcluster.ConsulClusterConfig {
	...
	Size: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.consulCluster.ConsulClusterTimeouts,
}
```
