...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/datahcpvaultsecretssecret"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs/data-sources/vault_secrets_secret#import import section} in the documentation of this resource for the id to use
