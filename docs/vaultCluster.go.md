...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v4/vaultcluster"
...
| <code><a href="#@cdktf/provider-hcp.vaultCluster.VaultCluster.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&vaultcluster.VaultClusterConfig {
	...
	ClusterId: *string,
	HvnId: *string,
	AuditLogConfig: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.vaultCluster.VaultClusterAuditLogConfig,
	Id: *string,
	MajorVersionUpgradeConfig: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.vaultCluster.VaultClusterMajorVersionUpgradeConfig,
	MetricsConfig: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.vaultCluster.VaultClusterMetricsConfig,
	MinVaultVersion: *string,
	PathsFilter: *[]*string,
	PrimaryLink: *string,
	PublicEndpoint: interface{},
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.vaultCluster.VaultClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-hcp.vaultCluster.VaultClusterConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
