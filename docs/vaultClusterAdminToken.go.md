...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/vaultclusteradmintoken"
...
&vaultclusteradmintoken.VaultClusterAdminTokenConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.vaultClusterAdminToken.VaultClusterAdminTokenTimeouts,
}
```
