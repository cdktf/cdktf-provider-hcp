...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/datahcpvaultsecretsapp"
...
| <code><a href="#@cdktf/provider-hcp.dataHcpVaultSecretsApp.DataHcpVaultSecretsAppConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.61.0/docs/data-sources/vault_secrets_app#id DataHcpVaultSecretsApp#id}. |
