...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/datahcpconsulversions"
...
&datahcpconsulversions.DataHcpConsulVersionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.dataHcpConsulVersions.DataHcpConsulVersionsTimeouts,
}
```
