...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/datahcpconsulversions"
...
&datahcpconsulversions.DataHcpConsulVersionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.dataHcpConsulVersions.DataHcpConsulVersionsTimeouts,
}
```
