...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/consulsnapshot"
...
&consulsnapshot.ConsulSnapshotConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.consulSnapshot.ConsulSnapshotTimeouts,
}
```
