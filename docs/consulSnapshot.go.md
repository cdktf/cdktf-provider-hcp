...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/consulsnapshot"
...
&consulsnapshot.ConsulSnapshotConfig {
	...
	SnapshotName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.consulSnapshot.ConsulSnapshotTimeouts,
}
```
