...
| <code><a href="#@cdktf/provider-hcp.waypointTemplate.WaypointTemplateConfig.property.useModuleReadme">useModuleReadme</a></code> | <code>boolean \| cdktf.IResolvable</code> | If true, will auto-import the readme form the Terraform module used. |
