...
```java
public void resetSkipStatusCheck()
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.108.0/docs#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-hcp.provider.HcpProviderWorkloadIdentity.property.token">token</a></code> | <code>java.lang.String</code> | The JWT token retrieved from an OpenID Connect (OIDC) or OAuth2 provider. |
