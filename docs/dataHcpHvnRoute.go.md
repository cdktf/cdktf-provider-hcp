...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/datahcphvnroute"
...
&datahcphvnroute.DataHcpHvnRouteConfig {
	...
	HvnRouteId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.dataHcpHvnRoute.DataHcpHvnRouteTimeouts,
}
```
