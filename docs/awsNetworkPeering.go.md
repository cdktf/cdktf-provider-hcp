...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/awsnetworkpeering"
...
&awsnetworkpeering.AwsNetworkPeeringConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.awsNetworkPeering.AwsNetworkPeeringTimeouts,
}
```
