...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/datahcpconsulagenthelmconfig"
...
&datahcpconsulagenthelmconfig.DataHcpConsulAgentHelmConfigConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.dataHcpConsulAgentHelmConfig.DataHcpConsulAgentHelmConfigTimeouts,
}
```
