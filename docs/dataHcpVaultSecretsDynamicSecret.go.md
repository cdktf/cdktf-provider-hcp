...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/datahcpvaultsecretsdynamicsecret"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.106.0/docs/data-sources/vault_secrets_dynamic_secret#import import section} in the documentation of this resource for the id to use
