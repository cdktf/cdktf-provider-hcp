...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v4/datahcphvnpeeringconnection"
...
&datahcphvnpeeringconnection.DataHcpHvnPeeringConnectionConfig {
	...
	PeeringId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.dataHcpHvnPeeringConnection.DataHcpHvnPeeringConnectionTimeouts,
}
```
