...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/datahcppackeriteration"
...
&datahcppackeriteration.DataHcpPackerIterationConfig {
	...
	Id: *string,
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.dataHcpPackerIteration.DataHcpPackerIterationTimeouts,
}
```
