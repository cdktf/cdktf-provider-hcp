...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/azurepeeringconnection"
...
&azurepeeringconnection.AzurePeeringConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.azurePeeringConnection.AzurePeeringConnectionTimeouts,
}
```
