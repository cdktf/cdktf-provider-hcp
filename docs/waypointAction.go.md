...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/waypointaction"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.106.0/docs/resources/waypoint_action#import import section} in the documentation of this resource for the id to use
...
&waypointaction.WaypointActionConfig {
	...
	Name: *string,
	Request: github.com/cdktf/cdktf-provider-hcp-go/hcp/v10.waypointAction.WaypointActionRequest,
	Description: *string,
	ProjectId: *string,
}
```
...
&waypointaction.WaypointActionRequest {
	Custom: github.com/cdktf/cdktf-provider-hcp-go/hcp/v10.waypointAction.WaypointActionRequestCustom,
}
```
