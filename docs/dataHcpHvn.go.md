...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v4/datahcphvn"
...
| <code><a href="#@cdktf/provider-hcp.dataHcpHvn.DataHcpHvn.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datahcphvn.DataHcpHvnConfig {
	...
	HvnId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v4.dataHcpHvn.DataHcpHvnTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-hcp.dataHcpHvn.DataHcpHvnConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
