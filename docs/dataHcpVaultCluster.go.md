...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v3/datahcpvaultcluster"
...
| <code><a href="#@cdktf/provider-hcp.dataHcpVaultCluster.DataHcpVaultCluster.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datahcpvaultcluster.DataHcpVaultClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v3.dataHcpVaultCluster.DataHcpVaultClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-hcp.dataHcpVaultCluster.DataHcpVaultClusterConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
