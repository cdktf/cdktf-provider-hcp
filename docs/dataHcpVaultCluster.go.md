...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v5/datahcpvaultcluster"
...
&datahcpvaultcluster.DataHcpVaultClusterConfig {
	...
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v5.dataHcpVaultCluster.DataHcpVaultClusterTimeouts,
}
```
