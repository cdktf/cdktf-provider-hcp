...
```go
import "github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/datahcpvaultcluster"
...
&datahcpvaultcluster.DataHcpVaultClusterConfig {
	...
	ProjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcp-go/hcp/v10.dataHcpVaultCluster.DataHcpVaultClusterTimeouts,
}
```
